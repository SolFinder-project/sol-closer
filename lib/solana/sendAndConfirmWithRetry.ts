 ...
 * No confirmation wait: UI shows success immediately; tx lands on-chain. Avoids WebSocket
 * errors in console when using HTTP-only RPC (e.g. proxy). Retries only on sendRawTransaction failure.
 */
