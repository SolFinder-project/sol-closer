      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <section>
            ...
            <div className="p-4 bg-dark-card border border-dark-border rounded-lg">
              <p>
                ...
                <strong>Adresse du siège social :</strong> 8 place roger salengro, 31000 Toulouse, France<br />
                <strong>Directeur de la publication :</strong> Maxime Lohier<br />
          ...
          <section>
            ...
            <p>Le site SolPit est hébergé par :</p>
          ...
          <section>
            ...
            <p>
              ...
              etc.) est la propriété exclusive de SolPit, à l'exception des marques et contenus 
              appartenant à des tiers.
            </p>
            <p className="mt-4">
              <strong>Code source :</strong> Le code source de SolPit est publié sous licence 
          ...
          <section>
            ...
            <div className="p-4 bg-dark-card border border-dark-border rounded-lg">
              <p>
                <strong>Responsable :</strong> Maxime Lohier<br />
                <strong>Email :</strong> solcloser@gmail.com<br />
                <strong>Adresse :</strong> 8 place roger salengro, 31000 Toulouse, France
              </p>
            </div>
          ...
          <section>
            ...
            <p>
              SolPit n'utilise pas de cookies de tracking ou de ciblage publicitaire.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Design et développement :</strong> SolPit</li>
