        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <section>
            ...
            <div className="p-4 bg-dark-card border border-dark-border rounded-lg">
              <p>
                <strong>Data Controller:</strong> Maxime Lohier<br />
                <strong>Business ID:</strong> Pending registration<br />
                <strong>Address:</strong> 8 place roger salengro, 31000 Toulouse, France<br />
          ...
          <section>
            ...
            <p className="mt-4">
              <strong>To exercise your rights, contact us at:</strong> solcloser@gmail.com
            </p>
          </section>
