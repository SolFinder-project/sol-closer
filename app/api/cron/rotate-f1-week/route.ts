 ...
 * Passes DAS options via getDasOptionsForCron: canonical URL env first (Helius Allowed Domains),
 * then request origin / VERCEL_URL so Creator NFT race-time bonus is applied at close.
 */
